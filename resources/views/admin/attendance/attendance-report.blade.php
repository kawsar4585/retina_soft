                        ...
                        <div class="card">
                            ...
                            <form class="row clearfix filter-form">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" value="{{$_GET['employee_name']??''}}" name="employee_name" placeholder="Employee" class="form-control" >
                            ...
                            <div class="row clearfix">
                                <div class="col-md-6">
                                    <span>Showing Data:  {{$_GET['employee_name']??''}} {{$_GET['from_date']}} - {{$_GET['to_date']}}</span>
                                </div>
                            </div>
                            @endif
                            <div class="table-responsive">
                                <table class="table card-table">
                                    ...
                                    <tbody>
                                        ...
                                        @endforelse
                                        <tr >
                                            <td colspan="5" class="totaldurationtext">Total Working Duration</td>
