   ...
   <ul class="ttr-header-navigation">
     ...
     <li>
        ...
        <div class="ttr-header-submenu">
             <ul>
                     {{-- <li><a href="{{url('admin/setting')}}">My profile</a></li> --}}
                                  <!--<li><a href="teacher-join-live.php">Live</a></li>-->
                     <li>
...
<div class="ttr-sidebar">
 <div class="ttr-sidebar-wrapper content-scroll">
  ...
  <nav class="ttr-sidebar-navi">
   <ul>
     <li class="@if(Request::is('admin/dashboard')) show active @endif">
     ...
     <li>
        <a href="#" class="ttr-material-button">
             ...
             <span class="ttr-label">Employee Management</span>
             <span class="ttr-arrow-icon"><i class="fa fa-angle-down"></i></span>
        </a>
        <ul>
             <li class="@if(Request::is('admin/employees')) show active @endif">
               <a href="{{url('admin/employees')}}" class="ttr-material-button">  <span class="ttr-arrow-icon"><i class="fa fa-angle-right"></i></span><span class="ttr-label">Employee List</span></a>
               <a href="{{url('admin/employee-create')}}" class="ttr-material-button">  <span class="ttr-arrow-icon"><i class="fa fa-angle-right"></i></span><span class="ttr-label">Employee Add</span></a>
     ...
     <li class="">
        <a href="{{url('admin/attendance-lists')}}" class="ttr-material-button">
             <span class="ttr-icon"><i class="fa fa-clipboard-user"></i></span>
             <span class="ttr-label">Attendance Lists</span>
        </a>
     </li>

     <li class="">
        <a href="{{url('admin/attendance-reports')}}" class="ttr-material-button">
             <span class="ttr-icon"><i class="fa fa-chart-bar"></i></span>
             <span class="ttr-label">Attendance Reports</span>
        </a>
     </li>
