...
<div class="page-wraper">
    <div class="account-form">
        <div class="account-head" style="">
            <a href="index.html"><img src="/assets/images/retina-logo.png" alt=""></a>
        </div>
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                <div class="input-group">
                                    <label>Name</label>
                                    <input name="name" id="first_name" type="text" class="form-control " value="{{ old('first_name') }}" required autocomplete="first_name" autofocus placeholder=" Name">
